...
#t.test()
print ("=======================================")
dt = (datetime.datetime.now()+datetime.timedelta(minutes=-30)).strftime("%Y-%m-%d %H:%M:%S")
print(dt) #2018-03-02 12:57:51
#转换成时间数组
timeArray = time.strptime(dt, "%Y-%m-%d %H:%M:%S")
#转换成时间戳
timestamp = round(time.mktime(timeArray)*pow(10,2))
print(timestamp)
print("---x---", round(time.time()*pow(10,2)))
...
print((datetime.datetime.now()+datetime.timedelta(days=-30)).strftime("%Y-%m-%d %H:%M:%S"))
print(dt) #2018-03-02 12:57:51
#转换成时间数组
timeArray = time.strptime(dt, "%Y-%m-%d %H:%M:%S")
#转换成时间戳
